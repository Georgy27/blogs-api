...
// routes
exports.postsRouter.get("/", sorting_pagination_middleware_1.pageSize, sorting_pagination_middleware_1.sortBy, sorting_pagination_middleware_1.pageNumberValidation, getUserIdFromAccessTokenMw.use.bind(getUserIdFromAccessTokenMw), (0, morgan_middleware_1.morgan)("tiny"), postsController.getAllPosts.bind(postsController));
...
exports.postsRouter.get("/:id", getUserIdFromAccessTokenMw.use.bind(getUserIdFromAccessTokenMw), (0, morgan_middleware_1.morgan)("tiny"), postsController.getPostById.bind(postsController));
...
exports.postsRouter.put("/:postId/like-status", jwtMw.use.bind(jwtMw), likeStatus_validation_1.likeStatusValidation, input_validation_middleware_1.inputValidationMiddleware, postsController.updateReaction.bind(postsController));
