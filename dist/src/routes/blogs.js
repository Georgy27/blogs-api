...
// routes
exports.blogsRouter.get("/", sorting_pagination_middleware_1.pageSize, sorting_pagination_middleware_1.sortBy, sorting_pagination_middleware_1.pageNumberValidation, (0, morgan_middleware_1.morgan)("tiny"), composition_root_1.blogsController.getAllBlogs.bind(composition_root_1.blogsController));
exports.blogsRouter.get("/:blogId/posts", sorting_pagination_middleware_1.pageSize, sorting_pagination_middleware_1.sortBy, sorting_pagination_middleware_1.pageNumberValidation, (0, morgan_middleware_1.morgan)("tiny"), composition_root_1.blogsController.getAllPostsForSpecifiedBlog.bind(composition_root_1.blogsController));
exports.blogsRouter.post("/", basic_auth_middleware_1.basicAuthMiddleware, nameValidation_1.nameValidation, descriptionValidation_1.descriptionValidation, websiteValidation_1.websiteValidation, input_validation_middleware_1.inputValidationMiddleware, (0, morgan_middleware_1.morgan)("tiny"), composition_root_1.blogsController.createBlog.bind(composition_root_1.blogsController));
exports.blogsRouter.post("/:blogId/posts", basic_auth_middleware_1.basicAuthMiddleware, titleValidation_1.titleValidation, shortDescriptionValidation_1.shortDescriptionValidation, contentValidation_1.contentValidation, input_validation_middleware_1.inputValidationMiddleware, (0, morgan_middleware_1.morgan)("tiny"), composition_root_1.blogsController.createPostForSpecifiedBlog.bind(composition_root_1.blogsController));
exports.blogsRouter.get("/:id", (0, morgan_middleware_1.morgan)("tiny"), composition_root_1.blogsController.getBlogById.bind(composition_root_1.blogsController));
exports.blogsRouter.put("/:id", basic_auth_middleware_1.basicAuthMiddleware, nameValidation_1.nameValidation, descriptionValidation_1.descriptionValidation, websiteValidation_1.websiteValidation, input_validation_middleware_1.inputValidationMiddleware, (0, morgan_middleware_1.morgan)("tiny"), composition_root_1.blogsController.updateBlogById.bind(composition_root_1.blogsController));
exports.blogsRouter.delete("/:id", basic_auth_middleware_1.basicAuthMiddleware, (0, morgan_middleware_1.morgan)("tiny"), composition_root_1.blogsController.deleteBlogById.bind(composition_root_1.blogsController));
