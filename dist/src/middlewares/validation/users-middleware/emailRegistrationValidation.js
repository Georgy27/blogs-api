...
let EmailRegistrationValidation = class EmailRegistrationValidation {
    constructor(usersQueryRepository) {
        this.usersQueryRepository = usersQueryRepository;
        this.emailRegistrationValidation = (0, express_validator_1.body)("email")
            .isEmail()
...
EmailRegistrationValidation = __decorate([
